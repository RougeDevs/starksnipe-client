...
export const EKUBO = {
    EKUBO_NFT: '0xbf8a9',
    EXCHANGE_ID: 2,
    EKUBO_TICK_SIZE: 1.000001,
    EKUBO_EXCHANGE: "0x07eee624919fae668387d0d34d86d67795e5c919bc994841581144977ef21c32",
    EKUBO_TICK_SPACING: 5982, // log(1 + 0.6%) / log(1.000001) :> 0.6% is the tick spacing percentage
    EKUBO_TICK_SIZE_LOG: Math.log(1.000001)
}
