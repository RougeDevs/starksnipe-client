  ...
  ctx.reply(
    ...
    `🔗 Click to Buy/Sell below!`,
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "🟢 Buy", web_app: { url: `https://9fbe-2401-4900-1c6f-a6ea-2836-ef56-55f4-e612.ngrok-free.app?token=${sampleToken.address}` } },
            { text: "🔴 Sell", web_app: { url: `https://9fbe-2401-4900-1c6f-a6ea-2836-ef56-55f4-e612.ngrok-free.app?token=${sampleToken.address}` } },
          ],
        ],
      },
      parse_mode: "Markdown",
