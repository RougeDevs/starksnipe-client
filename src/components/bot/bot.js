...
function sendTokenInfo(ctx) {
    ...
    ctx.reply("\uD83D\uDE80 **New Token Alert** \uD83D\uDE80\n\n" +
        ...
        reply_markup: {
            inline_keyboard: [
                [
                    { text: "🟢 Buy", web_app: { url: "https://6cb8-2401-4900-1c6f-a6ea-c5b2-5a13-4824-817b.ngrok-free.app?token=".concat(sampleToken.address) } },
                    { text: "🔴 Sell", web_app: { url: "https://6cb8-2401-4900-1c6f-a6ea-c5b2-5a13-4824-817b.ngrok-free.app?token=".concat(sampleToken.address) } },
                ],
            ],
        },
        parse_mode: "Markdown",
